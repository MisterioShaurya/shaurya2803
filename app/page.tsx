    ...
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16">
        <header
          ...
          className="min-h-[100svh] flex items-start sm:items-center pt-[25vh] sm:pt-0 opacity-0"
        >
            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  Tech entrepreneur and full-stack builder crafting
                  <span className="text-foreground"> startup ecosystems</span> at the intersection of
                  <span className="text-foreground"> innovation</span>,
                  <span className="text-foreground"> technology</span>, and
                  <span className="text-foreground"> human collaboration</span>.
                </p>
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-6 lg:mt-0">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="text-foreground">Founder & Product Builder</div>
                  <div className="text-muted-foreground">SnapPitch.in</div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Full Stack", "Python", "Cybersecurity", "3D Modeling", "Web Dev"].map((skill) => (
                    <span
                      key={skill}
        ...
        >
          <div className="space-y-12 sm:space-y-16">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              <h2 className="text-3xl sm:text-4xl font-light">Projects & Work</h2>
        ...
        >
          <div className="space-y-12 sm:space-y-16">
            <h2 className="text-3xl sm:text-4xl font-light">Thoughts & Insights</h2>

            <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
              {[
                {
                  title: "Building SnapPitch: Lessons from Startup Ideation",
                  excerpt: "How the lack of a platform to find co-founders inspired the creation of SnapPitch.in and what we've learned so far.",
                  date: "Feb 2026",
                  readTime: "6 min",
                },
                {
                  title: "The Intersection of Cybersecurity and Web Development",
                  excerpt: "Why every developer should understand security fundamentals and how to build secure applications from day one.",
                  date: "Jan 2026",
                  readTime: "7 min",
                },
                {
                ...
                {
                  title: "Full Stack Development: The Path to Indie Hacking",
                  excerpt: "Why mastering full-stack development is essential for indie hackers and startup founders building their own products.",
                  date: "Nov 2025",
                  readTime: "6 min",
                },
              ].map((post, index) => (
        ...
        <section id="connect" ref={(el) => (sectionsRef.current[3] = el)} className="py-20 sm:py-32 opacity-0">
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            <div className="space-y-6 sm:space-y-8">
              <h2 className="text-3xl sm:text-4xl font-light">Let's Build Together</h2>

              <div className="space-y-6">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  Whether you're a founder looking to collaborate, a developer interested in building together, or an investor exploring our ventures — I'd love to connect and explore possibilities.
                </p>

                <div className="space-y-4">
                  <Link
                    href="mailto:shaurya@snappitch.in"
                    className="group flex items-center gap-3 text-foreground hover:text-muted-foreground transition-colors duration-300"
                  >
                    <span className="text-base sm:text-lg">shaurya@snappitch.in</span>
                    <svg
        ...
        <footer className="py-12 sm:py-16 border-t border-border">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
            <div className="space-y-2">
              <div className="text-sm text-muted-foreground">© 2026 Shaurya Deep. All rights reserved.</div>
              <div className="text-xs text-muted-foreground">Built with Next.js and passion | Designed for builders</div>
            </div>
